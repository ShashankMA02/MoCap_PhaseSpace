...
class MocapDataLogger:
    def __init__(self):
        ...
        self.csv_filename = "mocap_data2.csv"
    ...
    def mocap_callback(self, msg):
        ...
        for rigid_body in msg.rigids:
            if rigid_body.id == 1:
                ...
                x_mm = rigid_body.x * 1000
                y_mm = rigid_body.y * 1000
                z_mm = rigid_body.z * 1000
                # z_mm = rigid_body.z * 1000 - 845  # Subtract the platform height in mm
                ...
                self.pose_data = [x_mm, y_mm, z_mm, roll_deg, pitch_deg, yaw_deg]
