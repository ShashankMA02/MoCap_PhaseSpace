...
class MocapDataLogger:
    def __init__(self):
        ...
        self.csv_filename = "mocapHexa_data1.csv"
        ...
        self.home_position = [1547, 1565, -570, -3, -2, -60]
    ...
    def mocap_callback(self, msg):
        ...
        for rigid_body in msg.rigids:
            if rigid_body.id == 1:
                ...
                x_mm = round(rigid_body.x * 1000, 2)
                y_mm = round(rigid_body.y * 1000, 2)
                z_mm = round(rigid_body.z * 1000 - 845, 2)  # Subtract the platform height in mm and round
                ...
                roll_deg = round(euler[0] * 180.0 / 3.141592653589793, 2)
                pitch_deg = round(euler[1] * 180.0 / 3.141592653589793, 2)
                yaw_deg = round(euler[2] * 180.0 / 3.141592653589793, 2)
